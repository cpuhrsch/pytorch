...
std::tuple<Tensor, Tensor, Tensor> cudnn_batch_norm(
  ...
  throw std::runtime_error(
      "cudnn_batch_norm: ATen not compiled with cuDNN support");
}
...
std::tuple<Tensor, Tensor, Tensor> cudnn_batch_norm_backward(
    ...
    double epsilon) {
  throw std::runtime_error(
      "cudnn_batch_norm_backward: ATen not compiled with cuDNN support");
}
...
std::tuple<Tensor, Tensor, Tensor> cudnn_batch_norm(
  ...
  TensorDescriptor wdesc{expandScale(*weight, input->dim()),
