...
static void fill_tensor(int64_t scalar, Tensor& t_) {
  auto t = t_.view(-1);
...
static void test(Type& type, IntList shape, int64_t a=0, int64_t b=1) {
...
TEST_CASE("apply utils test", "[cpu]") {
  manual_seed(123);
