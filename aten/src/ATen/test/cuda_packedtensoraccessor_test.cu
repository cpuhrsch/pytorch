...
__global__ void test_tensor_packed_accessor_kernel(
    NestedTensorAccessor64<float, 1, RestrictPtrTraits> resa,
    NestedTensorAccessor64<float, 2, RestrictPtrTraits> t1a,
    NestedTensorAccessor64<float, 1, RestrictPtrTraits> t2a) {
...
// test GenericNestedTensorAccessor and Tensor.generic_packed_accessor
